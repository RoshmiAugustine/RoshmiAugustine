IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210125100532_EmailAssessmentTemplate_ViewNotes')
BEGIN
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: center; padding: 30px 0  30px 0;">
                                Hi {{personname}}, {{assessmentnotes}}Please click the "Start
...
BEGIN
    ...
    VALUES (N'20210125100532_EmailAssessmentTemplate_ViewNotes', N'3.1.4');
END;
