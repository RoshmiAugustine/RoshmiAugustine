IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201229122300_Config_EHRDefaultCollaborationID')
BEGIN
DECLARE @ConfigurationValueTypeID INT;
 ...
 SET @ConfigName = 'EHRDefaultCollaborationID';
 SET @ConfigValue = 5;
 SET @ConfigDesc = 'EHR Default Collaboration ID';
...
END
    ...
    VALUES (N'20201229122300_Config_EHRDefaultCollaborationID', N'3.1.4');
END;
