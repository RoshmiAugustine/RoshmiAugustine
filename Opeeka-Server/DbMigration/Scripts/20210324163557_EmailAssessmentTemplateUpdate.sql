                ...
                <td style="background-color: white; margin: 0 auto; margin-top:-3%;">
                    <table class="inner-table" style="margin: 0 auto;">   
                        <tbody>
                                ...
                                <td>
                                    <div style="display: block;text-align: center;">
                                        <h1 style="font-size: 25px; font-weight: bold; margin-bottom: 30px;">
                                            New Assessment Request</h1>
                                        <p style="color:#616161;"> Hi
                                            {{personname}},
                                            {{assessmentnotes}}Please click the "Start Assessment" button
                                            below to begin the
                                            process.
                                        </p>
                                        <p style="color:#616161;">
                                            Your ability to generate a code will expire in {{expiry}} hours.
                                        </p>
                                        <div>
                                            <img src="{{applicationUrl}}/assets/icons/doc1.png" alt="Assessment"  style="margin: 10px;"/>
                                        </div>
                                       <div style="margin: 35px;">
                                        <a href="{{emailurl}}" >
                                            <button
                                            class="styledButton" style="background-color:#227793;cursor: pointer; color: white; font-size: 20px; border-radius: 25px; box-shadow: 0px; border: none;  padding: 12px 20px;">Start
                                            Assessment</button>
                                        </a>
                                       </div>                                     
                                    </div>     
                            ...
                            <tr style="background-color: #e5b008; border-top: 15px solid #f4f4f4; border-bottom: 15px solid #f4f4f4; padding: 15px 20px 15px 20px;display: block; text-align: center;">
...
</html>' WHERE ConfigurationParameterContextID IN (SELECT ConfigurationParameterContextID FROM info.ConfigurationParameterContext 
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210324163557_EmailAssessmentTemplateUpdate')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20210324163557_EmailAssessmentTemplateUpdate', N'3.1.4');
END;
