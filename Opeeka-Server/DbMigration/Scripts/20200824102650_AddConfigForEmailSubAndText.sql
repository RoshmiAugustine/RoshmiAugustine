IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200824102650_AddConfigForEmailSubAndText')
BEGIN
BEGIN TRY
BEGIN TRANSACTION
 ...
 INSERT INTO @table_temp 
	SELECT 1,'AssessmentEmailSubject','Assessment Email Link Subject','Assessment Test Link'
	UNION
	SELECT 1,'AssessmentEmailText','Assessment Email Text','Please click the below link:'
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200824102650_AddConfigForEmailSubAndText', N'3.1.4');
COMMIT TRANSACTION
END TRY
BEGIN CATCH 
