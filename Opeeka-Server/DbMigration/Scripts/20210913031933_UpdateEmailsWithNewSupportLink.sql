...
BEGIN
   UPDATE info.Configuration set Value='
      ...
      <tbody>
        <tr style="background-color: #227793; height: 150px">
          <td style="text-align: center; padding: 20px; margin: 0 auto">
            <img
              src="{{applicationUrl}}/assets/icons/Logo.png"
              alt="Assessment"
            />
          </td>
        </tr>
                  ...
                  <td>
                    <div style="display: block; text-align: center">
                      ...
                      <p style="color: #616161">
                        Hi {{personname}}, {{assessmentnotes}}Please click the
                        "Start Assessment" button below to begin the process.
                      </p>
                      <p style="color: #616161">
                        Your ability to generate a code will expire in
                        {{expiry}} hours.
                      </p>
                      <div>
                        <img
                          src="{{applicationUrl}}/assets/icons/doc1.png"
                          alt="Assessment"
                          style="margin: 10px"
                        />
                      </div>
                  ...
                  >
                    <div style="display: block; text-align: center">
                      <div>
                        <img
                          style="height: 32px"
                          src="{{applicationUrl}}/assets/icons/email-logo.png"
                          alt="Assessment"
                        />
                      </div>
                      <div>&#169; 2020 All rights reserved Opeeka Inc.</div>
                      <div style="margin-bottom: 20px">
                        81 Blue Ravine Road Suite 120, Folsom, CA 95630
                      </div>
                      <div style="margin-bottom: 20px">
                        This email is a system generated message and the email
                        box is not monitored. <br />
                      ...
                      <div style="margin-bottom: 20px">
                        <a
                          href="https://www.opeeka.com/privacy-policy/"
                          target="_blank"
                          style="
                            color: #262325;
                            font-weight: bold;
                        ...
                        |
                        <a
                          href="https://www.opeeka.com/terms-of-use/"
                          target="_blank"
                          style="
                            color: #262325;
                            font-weight: bold;
                ...
                <tr style="padding: 30px; display: block; text-align: center">
                  <td>
                    <div style="display: block; text-align: center">
                      ...
                      <p style="color: #616161">Your Verification Code is:</p>
                      <p style="color: black; font-size: 24px">{{otpcode}}</p>
                      <p
                        style="color: #616161; max-width: 325px; margin: 0 auto"
                      >
                        Please copy this code above and paste it into the
                        website to begin completing your assessment. This code
                        will expire in {{expiry}} minutes.
                      </p>
                      <div style="margin-top: 25px">
                        <img
                          src="{{applicationUrl}}/assets/icons/key.png"
                          alt="Assessment"
                        />
                      </div>
                    </div>
                ...
                <tr style="display: block; text-align: center; padding: 25px">
                  ...
                  >
                    <div style="display: block; text-align: center">
                      ...
                      <div>&#169; 2021 All rights reserved Opeeka Inc.</div>
                      <div style="margin-bottom: 20px">
                        81 Blue Ravine Road Suite 120, Folsom, CA 95630
                      </div>
                      <div style="margin-bottom: 20px">
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210913031933_UpdateEmailsWithNewSupportLink')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20210913031933_UpdateEmailsWithNewSupportLink', N'3.1.4');
END;
