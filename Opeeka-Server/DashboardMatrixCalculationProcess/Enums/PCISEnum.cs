...
namespace DashboardMatrixCalculationProcess.Enums
{
    public class PCISEnum
    {
        public static class APIurl
        {
            ...
            public static string PersonQuestionnireMetrics = "api/person-questionnaire-metrics";
            public static string GetPersonQuestionnireMetrics = "api/person-questionnaire-metrics-list";
            public static string AllItemResponseBehaviours = "api/item-response-behavior-list";
            public static string AllItemResponseTypes = "api/item-response-type-list";
            public static string GetQuestionnaireItems = "api/questionnaire-item/{questionnaireId}";
            public static string GetAssessmentResponseForeachItems = "api/assessment-response-metrics-calculation/{personId}/{assessmentId}";
            public static string GetPersonAssessmentMetrics = "api/person-assessment-metrics-list";
            public static string PersonAssessmentMetrics = "api/person-assessment-metrics";
