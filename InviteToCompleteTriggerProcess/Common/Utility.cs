...
namespace InviteToCompleteTriggerProcess.Common
{
    public class Utility
    {
        ...
        public string RestApiCall(string url, bool isExternalAI = false, bool isLogin = false, string requestType = PCISEnum.APIMethodType.GetRequest, string cookie = null, string postParam = "")
        {
            string apiResult = "";
            try
            {
