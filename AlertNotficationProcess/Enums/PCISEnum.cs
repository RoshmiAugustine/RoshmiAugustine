...
namespace AlertNotficationProcess.Enums
{
    public class PCISEnum
    {
        public static class APIurl
        {
            ...
            public static string GetQuestionaireDetails = "api/questionaire-details/{questionnaireId}";
            ...
            public static string GetDetailsForEHRUpdate = "api/ehr-assessment/{assessmentId}/{personQuestionnaireId}/{helperId}";
            public static string GetHelperDetailsForAssessment = "api/helper-details/{userId}";
        }
