IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210114123353_Config_PeopleQuestionnaireURL')
BEGIN
 ...
 SET @ConfigName = 'PeopleQuestionnaireURL';
 SET @ConfigValue = 'people/details?assessmentID={assessmentid}&personIndex={personindex}&notificationType={notificationtype}&questionnaireID={questionnaireid}';
 SET @ConfigDesc = 'People Questionnaire URL';
...
-----------------------------------[info].[ConfigurationParameterContext]-----------------------------------------
 ...
 -----------------------------------[info].[Configuration]--------------------------------------------------------
    ...
    VALUES (N'20210114123353_Config_PeopleQuestionnaireURL', N'3.1.4');
END;
