IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201215063024_EmailAssessmentTemplate_LinkEdit')
BEGIN
 ---------------------------Assesment Mail Text HTML---------------------------------------------------------------
...
BEGIN
    ...
    VALUES (N'20201215063024_EmailAssessmentTemplate_LinkEdit', N'3.1.4');
END;
