IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210805075707_AddAssesmentAutoSave')
BEGIN
BEGIN TRY
BEGIN TRANSACTION
 ...
 INSERT INTO @table_temp 
	SELECT 1,'Assessment_AutoSave','Assessment AutoSave Time','3'
...
-----------------------------------[info].[ConfigurationParameterContext]-----------------------------------------
 ...
 INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20210805075707_AddAssesmentAutoSave', N'3.1.4');
COMMIT TRANSACTION
END TRY
BEGIN CATCH 
