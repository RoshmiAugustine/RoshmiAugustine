IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200824080006_AddConfigForFromEmailDisplayName')
BEGIN
BEGIN TRY
BEGIN TRANSACTION
...
-----------------------------------------------------------------------------------------------------
 ...
 SET @ConfigParameter = 'FromEmailDisplayName';
 SET @ConfigParameterDesc = 'From Email Display Name';

 INSERT INTO @table_temp 
	SELECT 3,'agency1','PCIS-Agency1'
	UNION
	SELECT 4,'agency2','PCIS-Agency2'
 -----------------------------------------------------------------------------------------------------
 ...
 INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200824080006_AddConfigForFromEmailDisplayName', N'3.1.4');
COMMIT TRANSACTION
END TRY
BEGIN CATCH 
