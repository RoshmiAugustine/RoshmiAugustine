IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201022080424_Config_Reminder_LimitInMonth_After_WindowClose')
BEGIN
DECLARE @ConfigurationValueTypeID INT;
 ...
 SET @ConfigName = 'Reminder_LimitInMonth_If_EndDate_Null';
 SET @ConfigValue = 12;
 SET @ConfigDesc = 'Reminder Notification Limit In Month If EndDate is null';
...
END
    ...
    VALUES (N'20201022080424_Config_Reminder_LimitInMonth_After_WindowClose', N'3.1.4');
END;
