IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201211181136_APIRateLimit_Config')
BEGIN
BEGIN TRY
BEGIN TRANSACTION
...
SELECT 1,'APIRateLimitCount','APIRateLimit Count','3'
UNION
SELECT 1,'APIRateLimitPeriod','APIRateLimit Period','1m'
UNION
SELECT 1,'APIRateLimitEndPoint','APIRateLimit EndPoint','POST:/api/email-assessment-otp'
...
-----------------------------------[info].[ConfigurationParameterContext]-----------------------------------------
 ...
 -----------------------------------[__EFMigrationsHistory]--------------------------------------------
    ...
    VALUES (N'20201211181136_APIRateLimit_Config', N'3.1.4');
COMMIT TRANSACTION
END TRY
BEGIN CATCH
