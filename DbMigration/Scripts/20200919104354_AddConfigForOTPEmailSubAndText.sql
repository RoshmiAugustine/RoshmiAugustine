IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200919104354_AddConfigForOTPEmailSubAndText')
BEGIN
BEGIN TRY
BEGIN TRANSACTION
 ...
 INSERT INTO @table_temp 
	SELECT 1,'AssessmentOTPEmailSubject','Assessment OTP Email Link Subject','Here''s Your Verification Code'
	UNION
	SELECT 1,'AssessmentOTPEmailText','Assessment OTP Email Text','<p>
<div>Your Verification Code is: </div>
<div>
{{otpcode}}
</div>
<div>
Please copy this code above and paste it into the website to begin com-
</div>
<div>
pleting your assessment,
This code will expire in {{expiry}} hours.
</div>
</p>'
...
-----------------------------------[info].[ConfigurationParameterContext]-----------------------------------------
 ...
 INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200919104354_AddConfigForOTPEmailSubAndText', N'3.1.4');
COMMIT TRANSACTION
END TRY
BEGIN CATCH 
