...
namespace FutureReminderScheduleProcess.Common
{
        ...
        public static DateTime FindStartDateOfTheWeek(this DateTime value)
        {
            ...
            switch (value.DayOfWeek)
            {
                case DayOfWeek.Sunday:
                    //Only place which differes from ReminderNotification Process.
                    //For OccurenceCounter > 1 If currentday(satrtdate).Week = sunday then start calculation from current day.
                    resultDate = value.AddDays(0);
                    break;
